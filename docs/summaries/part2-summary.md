...
在两台老虎机实验中，我们第一次体验了"探索 vs 利用"的矛盾：你想多拉赢面大的那台（利用），但又怕另一台其实更好（探索）。在 4×4 GridWorld 中，我们把 Q-Learning 的完整流程跑了一遍：
...
这个框架是第 7 章的起点——而 DPO 的核心发现，正是这个框架可以绕过 RM 直接优化。
...
> **下一站**：[Part 3: LLM 时代](/chapter07_alignment/intro)
